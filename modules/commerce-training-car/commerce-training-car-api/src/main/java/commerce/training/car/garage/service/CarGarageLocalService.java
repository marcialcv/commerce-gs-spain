...
public interface CarGarageLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>commerce.training.car.garage.service.impl.CarGarageLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the car garage local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CarGarageLocalServiceUtil} if injection and service tracking are not available.
	 */
